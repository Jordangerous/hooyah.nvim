...
map('n', '<S-Tab>', '<cmd>bprevious<cr>', { desc = 'Previous Buffer (Shift-Tab)' })
...
map("n", "<leader>ft", function() Snacks.terminal(nil, { cwd = LazyVim.root(), size = { height = 0.2} }) end, { desc = "Terminal (Root Dir)" })
